...
const job2 = new Job('job2', new Date(Date.now() + 10000), 'consoleHandler', { msg: 'Hello from job 2' });
const job3 = new Job('job3', new Date(Date.now() + 20000), 'consoleHandler', { msg: 'Hello from job 3' });
