...
const now = Date.now();
const job1 = new Job('job1', new Date(now + 5000), 'consoleHandler', { msg: 'Hello from job 1!' });
const job2 = new Job('job2', new Date(now + 10000), 'emailHandler', { msg: 'Hello from job 2!' });
const job3 = new Job('job3', new Date(now + 20000), 'defaultHandler', { msg: 'Hello from job 3!' });
